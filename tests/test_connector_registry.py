...
class TestConnectorRegistry(unittest.TestCase):
    ...
    def test_get_connector_instances(self):
        connector_instances = self.connector_registry.get_connector_instances(
            self.connector_id, self.postgres_config
        )
    ...
    def test_get_connector_instance(self):
        connector_instance = ConnectorRegistry.get_connector_instance(
            self.connector_instance_id, self.postgres_config
        )
